...
- [More On Format String Syntax](https://docs.python.org/3.5/library/string.html#format-string-syntax)
- [Different Ways of Formatting Strings](https://realpython.com/python-string-formatting/)
